package com.example.ingforunsutmobile
...
import com.example.ingforunsutmobile.databinding.ActivityHalaman2Binding
...
class HalamanActivity2 : AppCompatActivity() {
    ...
    private val gMapsUrl = "http://maps.google.com/maps/maps?q=loc:"
